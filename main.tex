...
Autre exemple : le blé (\textit{Triticum aestivum}) qui est un hybride allopolyploïde résultant de croisements entre plusieurs espèces de graminées, notamment \textit{Triticum urartu}, \textit{Aegilops speltoides} et \textit{Aegilops tauschii} \parencite{feldman2001origin, feldman2007domestication}.
