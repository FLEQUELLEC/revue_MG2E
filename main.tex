...
L’un des outils les plus utilisés pour mesurer l’admixture est la statistique D, ou test ABBA–BABA, initialement développé pour détecter l’introgression entre humains modernes et Néandertaliens.
...
Une valeur significative de D indique une violation de la bifurcation stricte, et donc un événement d’admixture interspécifique \parencite{green2010neandertal, durand2011testing}.
Des variantes récentes (f4-ratio, f-branch) permettent d’estimer la proportion d’ascendance introgressée dans les génomes.
