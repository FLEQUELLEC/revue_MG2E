...
Il est indéniable que les approches génomiques ont révolutionné l’étude de la spéciation et de l’admixture. En permettant d'acceder à la totalité des génomes, offrant une large vision de la diversité génétique, du flux de gènes et des mécanismes adaptatifs sous-jacents.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ABC_RF_model.png}
