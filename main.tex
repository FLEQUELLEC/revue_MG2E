...
Depuis cette séparation, de multiples événements d’admixture ont eu lieu. Le loup de l’Est apparaît comme une lignée distincte, ayant divergé du loup gris tout en présentant des traces d’échanges génétiques anciens avec le coyote, survenus il y a environ 37 000 ans.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/Canis_latrans.svg}
    ...
    Schéma synthétique adapté de \textcite{vilaca2023tracing} illustrant la chronologie des événements d’admixture entre le loup gris (\textit{Canis lupus}), le loup de l’Est (\textit{Canis lycaon}) et le coyote (\textit{C. latrans}).
    Les flèches représentent les principaux épisodes d’échanges génétiques :
    (i) divergence du loup de l’Est à partir du loup gris il y a environ 67 000 ans ;
    (ii) admixture ancienne avec le coyote vers 37 000 ans ;
    (iii) hybridation secondaire entre le loup de l’Est et le loup gris à l’origine du loup des Grands Lacs (~8 000 ans) ;
    (iv) admixture récente entre le loup de l’Est et les coyotes occidentaux ayant conduit à la formation des coyotes de l’Est (~1 000 ans).
    Les proportions relatives de flux de gènes sont indiquées par l’épaisseur des flèches.
    Ce diagramme illustre la nature réticulée des lignées du genre \textit{Canis} en Amérique du Nord et met en évidence la coexistence d’événements d’hybridation et de divergence au cours de la spéciation.}
...
\begin{center}
    \begin{minipage}{0.85\textwidth}
        \small
        \itshape
        L'intelligence artificielle a été utilisée pour la révision linguistique, la correction orthographique et la mise en forme du texte(LaTex).
    \end{minipage}\\[2cm]
