...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/Canis_latrans.png}
    \caption[Histoire évolutive des canidés nord-américains]{
        ...
        (iv) admixture récente entre le loup de l’Est et les coyotes occidentaux ayant conduit à la formation des coyotes de l’Est.
        Ce diagramme illustre la nature réticulée des lignées du genre \textit{Canis} en Amérique du Nord et met en évidence la coexistence
        d’événements d’hybridation et de divergence au cours de la spéciation.}
